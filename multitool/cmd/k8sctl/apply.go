...
//
// k8sctl apply: kubectl-like apply command for multitool
package k8sctl
...
var applyCmd = &cobra.Command{
	...
	Short: "Apply Kubernetes manifests (kubectl-like)",
...
func init() {
	applyCmd.Flags().String("provider", "", "Cloud provider (hetzner|azure|...)")
