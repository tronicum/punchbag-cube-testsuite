...
//
// k8sctl cordon: kubectl-like cordon command for multitool
package k8sctl
...
var cordonCmd = &cobra.Command{
	...
	Short: "Mark node as unschedulable (kubectl-like)",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			fmt.Printf("Error running kubectl cordon: %v\n%s\n", err, string(out))
			return
		}
