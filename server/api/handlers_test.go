...
func (m *MockStore) CreateCluster(cluster *sharedmodels.Cluster) (*sharedmodels.Cluster, error) {
	return cluster, nil
}
...
func (m *MockStore) UpdateCluster(id string, cluster *sharedmodels.Cluster) (*sharedmodels.Cluster, error) {
	return cluster, nil
}
func (m *MockStore) DeleteCluster(id string) error { return nil }
func (m *MockStore) CreateTestResult(result *sharedmodels.TestResult) (*sharedmodels.TestResult, error) {
	return result, nil
}
...
func (m *MockStore) UpdateTestResult(id string, result *sharedmodels.TestResult) (*sharedmodels.TestResult, error) {
	return result, nil
}
